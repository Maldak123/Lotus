...
const Chat = () => {
  ...
  return chat.length > 0 ? (
    <div className="relative h-full">
      <span className="pointer-events-none absolute inset-x-0 top-0 z-999 h-10 bg-linear-to-b from-[#111111] to-transparent" />

      <div ref={chatScrollRef} className="h-full overflow-y-auto">
        <div className="flex min-h-full flex-col justify-end gap-2 pt-6">
          {chat.map((e, index) => (
